...
A deep-learning pipeline for animal motion capture from video. MoCapV2 reconstructs 3D mesh, pose, and joint rotations for arbitrary animal species starting from image sequences, producing animation-ready BVH output that can be rendered in Blender.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/animotionlab26/mocapv2.git
   cd mocapv2
   ```
