...
- **Hardcoded blender path**: `render_bvh_videos.py` currently has `blender_pth = '/home/ma-user/.../blender'`. Edit that line for your environment (or refactor to pick it up from `$BLENDER`).
